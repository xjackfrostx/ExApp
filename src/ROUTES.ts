...
const ROUTES = {
    ...
    WORKSPACE_REPORT_FIELDS_INITIAL_LIST_VALUE: {
        route: 'workspaces/:policyID/reports/newReportField/initialValue',
        getRoute: (policyID: string) => `workspaces/${policyID}/reports/newReportField/initialValue` as const,
    },
